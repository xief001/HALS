...
all:HALS preread bronkerboschadj addm42MECATm4 separatereads modifym4file2 filter full_trim write_corrected2 bin instbin clean
...
HALS:src/HALS.cpp src/combinecliques2.cpp
	$(CXX) src/HALS.cpp src/combinecliques2.cpp -o HALS -mcmodel=large -O
...
instbin:
	$(MV) HALS preread bronkerboschadj addm42MECATm4 separatereads modifym4file2 filter full_trim write_corrected2 bin

clean:
	$(RM) src/HALS.o src/combinecliques2.o src/preread.o src/bronkerboschadj.o src/addm42MECATm4.o  src/separatereads.o  src/modifym4file2.o  src/filter.o  src/full_trim.o src/write_corrected2.o
