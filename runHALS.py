...
#################################
	mecat2pw1_command = 'mecat2pw -j 1 -t 16 -g 1 -x 0 -d ' + temp_dir + '/step1/' + 'allreads.fasta ' + ' -o ' + temp_dir + '/step1/' + 'allreads.fasta.m4 ' + ' -w ' + temp_dir + '/step1/' + 'tmpfold -a 1000 -n 200'
...
#####################################
	HALS1_command = 'HALS 1 -c ' + temp_dir + '/step1/' + 'clique1.txt' + ' -e ' + temp_dir + '/step1/' + 'edge1.txt' + ' -r ' + temp_dir + '/step1/' + 'allreads.fasta' + ' -m ' + temp_dir + '/step1/' +'allreads.fasta.m4' + ' -a ' + temp_dir + '/step1/' +'realireads1.fasta' + ' -de1 ' + temp_dir + '/step1/' + 'deletepairs1.txt'
...
####################################
	...
	mecat2pw2_command = ' mecat2pw -j 1 -t 16 -g 1 -x 0 -d ' + temp_dir + '/step1/' + 'realireads1.fasta ' + ' -o ' + temp_dir + '/step1/' + 'realireads1.fasta.m4 ' + ' -w ' + temp_dir + '/step1/' + 'tmpfold -a 1000 -n 200'
...
#################################
	...
	mecat2pw3_command = ' mecat2pw -j 1 -t 16 -g 1 -x 0 -d ' + temp_dir + '/step1/' + 'allreads0_corrected_filted1.fasta ' + ' -o ' + temp_dir + '/step2/' + 'allreads0_corrected_filted1.fasta.m4 '+ ' -w ' + temp_dir + '/step2/' + 'tmpfold -a 1000 -n 200'
...
#############################################
	...
	mecat2pw4_command = ' mecat2pw -j 1 -t 16 -g 1 -x 0 -d ' + temp_dir + '/step2/' + 'cor_incor.fasta ' + ' -o ' + temp_dir + '/step2/' + 'cor_incor.fasta.m4 '+ ' -w ' + temp_dir + '/step2/' + 'tmpfold -a 1000 -n 200'
...
#########################################
	...
	if err != 0:
		...
		exit(-1)
######################################
	mecat2cns2_command = 'mecat2cns -x 0 -i 1 -t 16 -l 10 -c 1 ' + temp_dir + '/step2/' + 'corrected2.m4 ' + temp_dir + '/step2/' + 'cor_incor.fasta ' + temp_dir + '/step2/' + 'allreads0_corrected_filted2.fasta '
